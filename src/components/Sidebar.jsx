...
const Sidebar = ({ isOpen, setIsOpen }) => {
    return (
        <>
            ...
            <aside className="hidden lg:block w-64 bg-gray-50  text-black p-6 border-r border-gray-600">
                ...
                <nav className="flex flex-col space-y-2">
                    ...
                    {/* <Link to="/dashboard/aadharsign" className="hover:text-gray-300">aadharsign</Link> */}
                </nav>
            </aside>
            {/* Sidebar for mobile screens */}
            {isOpen && (
                <div className="fixed inset-0 z-50 flex lg:hidden">
                    <div className="w-64 bg-gray-50 text-black p-6 min-h-full ">
                        <h2 className="text-xl font-bold mb-6">Menu</h2>
                        <nav className="flex flex-col space-y-2">
                            ...
                            {/* <Link to="/dashboard/aadharsign" className="hover:text-gray-300" onClick={() => setIsOpen(false)}>aadharsign</Link> */}
                        </nav>
                    </div>
                    {/* Backdrop */}
